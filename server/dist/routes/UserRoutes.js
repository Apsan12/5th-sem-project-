...
userRouter.delete("/user/cart/remove", verifyToken, UserController.removeAllFromCart);
userRouter.delete("/user/cart/remove/:cartId", verifyToken, UserController.removeFromCart);
...
userRouter.delete("/user/address/del/:index", verifyToken, UserController.removeAddress);
userRouter.put("/user/address/default/:index", verifyToken, UserController.setDefaultAddress);
